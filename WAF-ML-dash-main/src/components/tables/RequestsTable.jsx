						...
						{currentLogs.length > 0 ? (
							currentLogs.map((log) => (
								...
								>
									...
									<td className='px-6 py-4 whitespace-nowrap text-gray-300'>{log.method}</td>
									<td className='px-6 py-4 whitespace-nowrap text-gray-300 truncate max-w-xs'>{log.url}</td>
									<td className='px-6 py-4 whitespace-nowrap text-gray-300'>{new Date(log.timestamp).toLocaleString()}</td>
								</motion.tr>
							))
						) : (
							<tr>
